...
public class Demo {
    public static void main(String[] args) throws IOException {
        ...
        //<<UNCOMMENT THIS DEMO TO TEST YOUR CODE>>
         try(Reader baseReader = new FileReader("C:/Users/Isabella/IdeaProjects/SE2QuestionBank/src/exercises/exercise02_input_output/WelcomeX/RSPacketsEncrypted.txt");
             MrXReader myReader = new MrXReader(baseReader);
             PrintWriter myPrinter = new PrintWriter(System.out);
             MrXWriter myFileWriter = new MrXWriter(myPrinter)
             ) {
